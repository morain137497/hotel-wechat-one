...
<van-transition :show="show" :custom-style="'z-fl: '+(zIndex)" custom-class="van-toast__container">
...
global['__wxRoute'] = 'vant/toast/fl'
...
export default global['__wxComponents']['vant/toast/fl']
</script>
